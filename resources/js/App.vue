<template>
    <div v-if="isLoggedIn === true" id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px">
        <!--begin::Root-->
			...
			<div class="page d-flex flex-row flex-column-fluid">
				...
				<div id="kt_aside" class="aside aside-light aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
					...
					<div class="aside-logo flex-column-auto" id="kt_aside_logo">
						...
						<!--end::Logo-->
						<!--begin::Aside toggler-->
						<div id="kt_aside_toggle" class="btn btn-icon w-auto px-0 btn-active-color-primary aside-toggle" data-kt-toggle="true" data-kt-toggle-state="active" data-kt-toggle-target="#kt_body" data-kt-toggle-name="aside-minimize">
							...
							<div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
								...
								<div class="d-flex align-items-stretch flex-shrink-0">
									...
									<div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
										<!--begin::Menu wrapper-->
										<div class="">
											<span class="badge badge-light-success" style="padding: 10px;font-size: 14px;">
												{{ dateTime.dayOfWeek }}, {{ dateTime.dayOfMonth }} {{ dateTime.curMonth }} {{ dateTime.curyear }} 
												{{ dateTime.hours }}:{{ dateTime.minutes }}:{{ dateTime.seconds }}</span>
										</div>
										<div class="cursor-pointer symbol symbol-30px symbol-md-40px" style="margin:10px;">
											<img src="assets/media/avatars/300-1.jpg" alt="user"/>
										</div>
										<div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
											<h4 style="margin:10px;">{{login.name}}</h4>
										</div>
...
export default {
    ...
    methods: {
		...
		setDateTime() {
			const date = new Date();
			const weekday = new Array('Minggu', 'Senin', 'Selasa', 'Rabu', 'Kamis', 'Jumat', 'Sabtu');
			const months = new Array('Januari', 'Febuari', 'Maret', 'April', 'Mei', 'Juni', 'Juli', 'Augustus', 'September', 'Ocktober', 'November', 'Desember');
			this.dateTime = {
